...
Человека можно называть логином, именем или алиасом из `contacts.md` (регистр не важен).
...
один файл. Курсор у каждого агента свой и хранится локально, в клоне хаба.
