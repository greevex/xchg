...
Без плагинов — [docs/ru/install.md](docs/ru/install.md). Нужны `bash` ≥ 3.2, `git`, `awk`, `sed`,
...
| | |
|---|---|
| [docs/ru/install.md](docs/ru/install.md) | установка, хуки, обновление |
...
Скилл для Claude Code — [skills/exchange](skills/exchange/SKILL.md), эталон контракта хаба (на английском) —
